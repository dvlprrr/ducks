const data = {
    "ducks": [
        ...
        },
        {
            ...
            "img": "/images/giraffe-duck.png"
        },
        {
            "id": 2,
            "name": "Зебрутка",
            "description": "Эта пугливая красавица была замечена в Центральной Африке. Криптоуткологи установили, что этих величественных зеброуток можно встретить только в безветренную ночь на горе под полной луной в зените.",
            "img": "/images/zebra-duck.png"
        },
        {
            "id": 3,
